describe('my first test', () => {
    ...
    beforeEach(() => {
        //We need to put code inside of the beforeEach that resets the state so that we don't pollute future tests with changes that have been made in previous tests. 
        //Reset the state
        sut = {}
    })
    ...
    //the functions should have strings that make sense when appended to the describe name
    it('should be true if true', () => {
        //arrange, set a new property called "a", set to false
        sut.a = false;
